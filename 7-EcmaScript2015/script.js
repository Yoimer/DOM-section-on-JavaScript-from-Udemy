...
// //ES6 (using two arguments in .map method)
...
//     const age = now - el;
//     return `Age element ${index}: ${2016 - el}`;
// });
// console.log(ages6);
...
var box5 = {
    ...
    clickMe: function() {
        ...
        // saves 'this' keyword from box5 to be later used in addEventListener callback function
        var self = this;
        document.querySelector('.green').addEventListener('click', function() {
            // 'this' keyword no longer belongs to the previous 'this' from
            // color and position in box5, we're using a callback function
